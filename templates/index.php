<main>
    ...
    <div class="aboutMe__filter">
      <div class="aboutMe__cont">
        <div class="aboutMe__img">
          <div><img src="/src/img/262ad39ffe580657b8705cc196a2bd27.png" alt="" /></div>
        </div>
        <section class="aboutMe__desc">
          <h1>Alexander Plotnikov_</h1>
          <p class="status">Frontend/backend developer</p>
          <div class="contacts">
            <div class="fone"><span class="title">Phone:</span> <span class="value">+79242521756</span></div>
            <div class="email"><span class="title">Email:</span> <span class="value">lotos_toi@mail.ru</span></div>
          </div>
          <div class="sotsseti">
            <a href="#"><i class="fa fa-github" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
  ...
  <section class="hello wrapper">
    <div class="hello__cont">
      ...
      <button class="hello__button"><i class="fa fa-download" aria-hidden="true"></i><span>Скачать резюме</span></button>
    </div>
  </section>
  <section class="resume wrapper" id="resume">
    <div class="resume__cont">
      <h3 class="resume__title">Резюме_</h3>
